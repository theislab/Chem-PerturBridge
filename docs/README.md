...
- [Core pseudobulk schema](https://github.com/theislab/op3_v2/blob/main/docs/Format_Pseudobulk.ipynb)
- `op3_v2/docs/STANDARDIZATION.md` - a more detailed description of how to standardize data.